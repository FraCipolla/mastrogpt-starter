...
# domain = "itch.io" # <- put your domain to be crawled
# full_url = "https://itch.io/" # <- put your domain to be crawled with https or http
...
#     # print("crawler cwd: " + os.getcwd() + " ls:\n" + __file__)
